"use strict";
app.controller('UserSearchCategoryController', ['$scope','$http','$filter','$routeParams','$location','ngDialog','FetchBooksService','SearchSortService','SubscriptionService','BookmarkService','RequestBookService','MailService', function($scope,$http,$filter,$routeParams,$location,ngDialog,FetchBooksService,SearchSortService,SubscriptionService,BookmarkService,RequestBookService,MailService){
