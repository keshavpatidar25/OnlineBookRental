...
<%
	...
	final Logger logger = Logger.getLogger("UserIssueBookJsp");
	logger.info("Inside User Issue Book Controller");
	try {
		User user = new User();
		Book book = new Book();
		...
		String result;
		try{
			result=new BookService().checkBookStatusBeforeIssue(user, book);
