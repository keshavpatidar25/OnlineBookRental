...
<%
	...
	final Logger logger = Logger.getLogger("UserBookmarkDetailsJsp");
	logger.info("Inside User Bookmark Details Controller");
	try {
		User user = new User();
		String result;
		...
		try{
			booksList = new BookDao().getBookmarkedBooksDetails(user);
			result="SUCCESS";
