...
<%
	...
	final Logger logger = Logger.getLogger("SearchByCategoryJsp");
	logger.info("Inside Search By Category Controller");
	try {
		String result;
		...
		try{
			categoryList=new BookDao().getBookCategories();
			booksList = new BookDao().getBooksListByCategory(filter);
			result = "SUCCESS";
