...
<%
	...
	final Logger logger = Logger.getLogger("OperatorDeleteBookJsp");
	logger.info("Inside Operator Delete Book Controller");
	try {
		...
		try{
			result=new BookService().checkAvailabilityBeforeDelete(book);
