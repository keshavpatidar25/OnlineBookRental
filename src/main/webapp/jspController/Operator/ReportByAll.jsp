...
<%
	...
	final Logger logger = Logger.getLogger("OperatorReportByAllJsp");
	logger.info("Inside Operator Report By All Controller");
	try {
 	...
 	//convert JSON string to Map
		map = mapper.readValue(request.getParameter("jsonReport"),
 		...
 		try{
			...
			map.put("reportDetails",new ReportService().getReport(fromDate, toDate, os));
			map.put("reportDetailsSum",new RequestDao().getReportsSum(fromDate, toDate));
